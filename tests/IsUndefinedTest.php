...
class IsUndefinedTest extends TestCase
{
    ...
    public function test_to_string(): void
    {
        ...
        self::assertIs('is undefined and is undefined', self::logicalAnd(self::isUndefined(), self::isUndefined())->toString());
        self::assertIs('is defined and is defined', self::logicalAnd(self::isDefined(), self::isDefined())->toString());
    }
}
