...
class ThrowsTest extends TestCase
{
    ...
    public function test_throws(): void
    {
        ...
        static::assertFalse(self::doesNotThrow(RuntimeException::class)->evaluate($f1, '', true));
        static::assertTrue(self::doesNotThrow(new RuntimeException('Test1'))->evaluate($f1, '', true));
    }
