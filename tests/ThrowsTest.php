...
class ThrowsTest extends TestCase
{
    ...
    public function test_to_string(): void
    {
        ...
        self::assertIs('throws RuntimeException and throws RuntimeException', self::logicalAnd(self::throws(RuntimeException::class), self::throws(RuntimeException::class))->toString());
        self::assertIs('throws RuntimeException and does not throw RuntimeException', self::logicalAnd(self::throws(RuntimeException::class), self::doesNotThrow(RuntimeException::class))->toString());
    }
}
